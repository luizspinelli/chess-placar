...
- A resposta da IA passa por `mdParaHtml`, que escapa HTML — não renderizar markdown da IA por outro caminho. Ela agrupa título + conteúdo em `<section>`; é o que o CSS de `.ia .texto` distribui em colunas (`columns`), então toda saída dela precisa continuar em blocos de seção.
