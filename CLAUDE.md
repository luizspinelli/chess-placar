...
- **Cache** (`placar-chesscom:evals`): `{url: {p: profundidade, t, e: [cp…] | null}}`, poda para as 600 mais recentes. `e: null` marca partida que o motor não conseguiu ler, para não tentar de novo. Pedir profundidade maior refaz só o que está abaixo dela.
