...
- **`parsePGN(g)`** (~linha 995) — extrai abertura (do header ECOUrl), todos os lances (`san`) e relógios (`clks`) do PGN; memoizado em `g._pgn`. `linhaPrincipal` só olha os 12 primeiros lances; o dossiê da IA usa o resto.
