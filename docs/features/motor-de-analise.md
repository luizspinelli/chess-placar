...
Dois caminhos. O botão **Analisar** da aba Análise roda o motor nas partidas pendentes e em seguida chama a IA com tudo (`analisarTudo`). Dentro de **configurar**, a linha **Motor** dá o controle fino: profundidade (10 rápida, 12 padrão, 14 profunda) e **Só o motor** — roda sem chave e sem custo, gera os cards da aba Erros e precisão — nas mesmas últimas 100 da modalidade que o dossiê usa. A barra de ação resume o estado ("motor 65/100 em profundidade 12"); enquanto roda, a barra de progresso e o link **parar** aparecem logo abaixo dela.
