...
## Como testar
Automatizado: `tests/texto.test.js` cobre `mdParaHtml`, `secoesMd` e `posicaoRelatorio` (inclusive o escape de HTML vindo da IA); `tests/dossie.test.js` cobre o tamanho do dossiê.
