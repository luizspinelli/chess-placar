...
- Depois de mexer em código compartilhado, percorrer com o console aberto: tela inicial → busca → as dez abas de KPI → modal do gráfico → modal da abertura → modo simples → largura de celular. Usar um nick real (`?nick=hikaru`) ou o botão "Veja um exemplo".
